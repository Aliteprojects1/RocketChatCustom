...
window.addEventListener('message', function(msg) {
    ...
    if (typeof msg.data ==='string') {
        if (msg.data === 'maximize') {
            document.querySelector('.livechat-room').className = 'livechat-room big';
            console.log(document.querySelector('.livechat-room'));
            console.log(document.querySelector('.livechat-room').className);
 		    document.querySelector('.input-message').focus();
        }
        if (msg.data === 'close') {
            document.querySelector('.livechat-room').className = 'livechat-room';
        }
    }
}, false);
